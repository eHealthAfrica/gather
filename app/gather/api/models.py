...
class Survey(models.Model):
    ...
    # This is used to fetch the entities extracted by the linked autogenerated
    # schemas, project schemas, mapping rules...
    # as opposed to the ones extracted by the manual mapping rules
    family = models.TextField(
        default='gather',
        verbose_name=_('Schema family'),
        help_text=_('This schema family englobes all the schemas autogenerated by this project.'),
    )
